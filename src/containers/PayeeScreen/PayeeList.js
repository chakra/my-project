    ...
    render(){
        return (
            <View style={styles.container}>
                ...
                >
                    {this.state.isOpenMenu ? <Navbar icon="times" navBarTitle="Payees" showMenu={this.closeMenu.bind(this)}/> : <Navbar icon="bars" navBarTitle="Payees" showMenu={this.showMenu.bind(this)}/>}
                    <TextInput
